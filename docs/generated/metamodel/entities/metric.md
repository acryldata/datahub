...
| semanticModel | string |  | The semantic model that defines this metric. Authoritative non-lineage membership pointer (`Model... | Searchable, → ModeledBy |
...
| fieldUpstreams | [Edge](#edge)[] |  | Schema fields this metric reads (column-level lineage). The parent dataset is SchemaFieldUrn.pare... | Searchable, → Consumes |
