...
public class IngestionMetricsEmitterTest {
   ...
   * 1246 total elements"}). Without {@link
   * com.linkedin.metadata.ingestion.IngestionRunReport.LogEntryDeserializer}, Jackson throws a
   * {@code MismatchedInputException} when it encounters that string while trying to construct a
